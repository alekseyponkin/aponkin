...
/**
 * Class CarDaoAnnotationHibernateImplTes.
 *
 * @author Ponkin Aleksey
 * @version 1.0.0
 * @since 17.04.19.
 */
public class CarDaoAnnotationHibernateImplTest {
    /**
     * Session factory of hibernate mapping on annotation.
     */
    private final static SessionFactory FACTORY = new Configuration().configure("carAnnotationHibernate.cfg.xml").buildSessionFactory();
